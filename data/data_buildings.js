...
bulIncome : The income per second the building provides per second
...
*/
function Building(id, name, desc, cost = 0, baseCost = 0, count = 0, income = 0) {
    this.bulId = id;
    this.bulName = name;
    this.bulDesc = desc;
    this.bulCost = cost;
